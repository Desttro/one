/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1230bd9ad6192306311b177b6716197e)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "ZeroDO";
	}
	interface Env {
		CF_TEST: "test it works!";
		DEBUG: string;
		ONE_CLOUDFLARE_PLUGIN: string;
		ONE_SERVER_URL: string;
		ZERO_UPSTREAM_DB: string;
		ZERO_CVR_DB: string;
		ZERO_AUTH_JWKS_URL: string;
		ZERO_CHANGE_DB: string;
		ZERO_JWT_SECRET: string;
		ZERO_REPLICA_FILE: string;
		VITE_PUBLIC_ZERO_SERVER: string;
		BETTER_AUTH_SECRET: string;
		GITHUB_CLIENT_ID: string;
		GITHUB_CLIENT_SECRET: string;
		ZERO_DO: DurableObjectNamespace /* ZeroDO */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CF_TEST" | "DEBUG" | "ONE_CLOUDFLARE_PLUGIN" | "ONE_SERVER_URL" | "ZERO_UPSTREAM_DB" | "ZERO_CVR_DB" | "ZERO_AUTH_JWKS_URL" | "ZERO_CHANGE_DB" | "ZERO_JWT_SECRET" | "ZERO_REPLICA_FILE" | "VITE_PUBLIC_ZERO_SERVER" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
